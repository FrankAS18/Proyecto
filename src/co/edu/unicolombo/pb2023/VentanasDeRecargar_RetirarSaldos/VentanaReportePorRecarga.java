 ...
 * @author ASUS
 */
public class VentanaReportePorRecarga extends javax.swing.JDialog {

    /**
     * Creates new form ReportePorRetiro
     */
    public VentanaReportePorRecarga(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("REPORTE POR RECARGA DE SALDO");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        for (int i = 0; i < listaUsuarios.size(); i++) {
            Recarga_Retiro recarga = listaUsuarios.get(i);  
            filas [i][0] = recarga.id_recarga;   
            filas [i][1] = recarga.usuario.nombre;   
            filas [i][2] = recarga.usuario.correo;   
            filas [i][3] = recarga.usuario.documento; 
            filas [i][4] = fechaActual;   
            filas [i][5] = recarga.saldoRecargado;   
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaReportePorRecarga.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaReportePorRecarga dialog = new VentanaReportePorRecarga(new javax.swing.JFrame(), true);
