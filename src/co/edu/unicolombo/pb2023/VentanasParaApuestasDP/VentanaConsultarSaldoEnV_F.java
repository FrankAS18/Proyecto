 ...
 * @author ASUS
 */
public class VentanaConsultarSaldoEnV_F extends javax.swing.JDialog {


    /**
     * Creates new form VentanaConsultarSaldo
     */
    public VentanaConsultarSaldoEnV_F(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void botonAtrasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAtrasActionPerformed
        this.dispose();
        VentanaParaFutbols ventana2 = new VentanaParaFutbols(null, rootPaneCheckingEnabled);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaConsultarSaldoEnV_F.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaConsultarSaldoEnV_F dialog = new VentanaConsultarSaldoEnV_F(new javax.swing.JFrame(), true);
