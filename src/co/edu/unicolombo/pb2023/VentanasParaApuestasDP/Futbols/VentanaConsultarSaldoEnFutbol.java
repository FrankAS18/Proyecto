 ...
 * @author ASUS
 */
public class VentanaConsultarSaldoEnFutbol extends javax.swing.JDialog {


    /**
     * Creates new form VentanaConsultarSaldo
     */
    public VentanaConsultarSaldoEnFutbol(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        botonCerrar.setBackground(new java.awt.Color(0, 0, 204));
        botonCerrar.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        botonCerrar.setForeground(new java.awt.Color(255, 255, 255));
        botonCerrar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/arrow_logout_exit_close_cancel_icon_208165.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaConsultarSaldoEnFutbol.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaConsultarSaldoEnFutbol dialog = new VentanaConsultarSaldoEnFutbol(new javax.swing.JFrame(), true);
