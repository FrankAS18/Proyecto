...
public class VentanaParaFutbol11 extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 390, -1, -1));
        ...
        jPanel1.add(botonConsultarSaldo, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 440, -1, -1));
        ...
        jPanel1.add(txtCorreo, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 330, 360, 30));
        ...
        jPanel1.add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 330, 100, 30));
    ...
    public class EquiposEnfrentamientos {
        ...
        public void realizarApuestaJuego1(JComboBox<String> comboBox1 , ArrayList<EquiposFutbol> equiposAleatorios) {
            ...
            comboBox1.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    ...
                    // Obtenemos el ganador real del primer enfrentamiento utilizando la función seleccionarGanadores
                    ...
                    String correo = txtCorreo.getText().trim(); // Trim para eliminar espacios en blanco al principio y al final
                    if (correo.isEmpty()) {
                        JOptionPane.showMessageDialog(null, "Por favor, ingrese su correo para realizar la apuesta.");
                    ...
                    if (usuarioBd != null) {
                        ...
                        // Obtenemos el correo del cliente para hacer las demas operaciones
                        Usuario u = obtenerUsuario(correo);
                        
                        JOptionPane.showMessageDialog(null, u.nombre + " !SUERTE¡");
                        
                        // Obtener el objeto Recarga_Retiro asociado al usuario
                        Recarga_Retiro recargaRetiroUsuario = Recarga_Retiro.recarga_retiroBD.get(u.documento);
                        
                        Map<String, Recarga_Retiro> r = Recarga_Retiro.recarga_retiroBD;
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        equiposManager.realizarApuestaJuego1(jComboBox1, equiposAleatorios);
